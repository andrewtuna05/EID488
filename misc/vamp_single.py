...
def obj_expression(model):
    if choice == 1:
        ...
        return 1.53125 * (model.x[2] / 32 + 3 * model.x[6] / 80)
    elif choice == 3:
        return 1.3125 * (3 * (model.x[3] + 50) / 32 + 3 * model.x[6] / 80)
    elif choice == 4:
        return 2.40625 * ( (model.x[3] + 50) / 4 + 3 * model.x[6] / 80)
